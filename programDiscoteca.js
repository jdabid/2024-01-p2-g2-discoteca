...
function ingresarPersona(){
    ...
    else 
    {
        ...
        else
        {
            ...
            {
                let genero = readlineSync.question('Ingrese su genero f/m: ');
                while (genero.toLowerCase() != 'f' && genero.toLowerCase() != 'm') {
                    console.error(`debe escribir "f" o "m" para indicar su genero`);
                    console.dir(`Usted digitó ${genero}`);
                    genero = readlineSync.question(` Escriba su genero `);
                }
